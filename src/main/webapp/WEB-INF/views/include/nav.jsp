...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.60:9090/JspringProject" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    ...
    <c:if test="${!empty sessionScope.mid }"><a href="${ctp}/member/memberLogout" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Logout</a></c:if>
