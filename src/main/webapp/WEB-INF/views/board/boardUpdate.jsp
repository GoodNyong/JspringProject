		...
		<form name="myform" method="post">
			<table class="table table-bordered">
				...
				<tr>
					<th>글내용</th>
					<td>
						<textarea row="10" name="content" id="CKEDITOR" class="form-control" required>${vo.content }</textarea>
				...
				<tr>
					<th>공개여부</th>
					<td><input type="radio" name="openSw" id="openSw1" value="OK" ${vo.openSw == 'OK' ? 'checked' : '' } /> 공개 &nbsp;
					<input type="radio" name="openSw" id="openSw2" value="NO" ${vo.openSw == 'NO' ? 'checked' : '' } /> 비공개</td>
				</tr>
				<tr>
